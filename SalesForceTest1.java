...
public class SalesForceTest1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//div[@class='requiredInput']//input[@type='text'])[2]")).sendKeys("vivekevent1");
		...
		driver.findElement(By.name("file")).sendKeys("C:\\Users\\JE293PT\\harsh.txt");
		Thread.sleep(3000);
